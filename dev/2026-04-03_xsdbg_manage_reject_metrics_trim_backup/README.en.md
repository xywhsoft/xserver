...
- `http_metrics / http_metrics_json` also no longer expose builtin control-surface reject stats such as `api_disabled / reload_busy / check_config_failed`; they now stay focused on protocol and stability diagnostics
