...
gcc main.c tcc/libtcc.c tcc/tcc_builtin_vfs.c tcc/LzmaDec.c src/script/tcc_builtin_resources.c \
	-Ilib -Itcc -DCONFIG_TCC_BUILTIN_VFS -DCONFIG_TRIPLET=\"$TCC_TRIPLET\" -O2 -s -Wall \
	-o release/xs $WINDRES_OBJ -ldl -lpthread -lm
