...
void Request_Chart_Get(XS_ServerObject objServer, XS_HostObject objHost, struct mg_connection* c, struct mg_http_message* hm)
{
	...
	xvoTableSetText(xAxis, "type", 4, "category", 0, XVO_SDT_STR_U8, FALSE);
	xvalue data = xvoCreateArray();
	xvoTableSetValue(xAxis, "data", 4, data, TRUE);
	xvoArrayAppendText(data, "Mon", 0, XVO_SDT_STR_U8, FALSE);
	xvoArrayAppendText(data, "Tue", 0, XVO_SDT_STR_U8, FALSE);
	xvoArrayAppendText(data, "Wed", 0, XVO_SDT_STR_U8, FALSE);
	xvoArrayAppendText(data, "Thu", 0, XVO_SDT_STR_U8, FALSE);
	xvoArrayAppendText(data, "Fri", 0, XVO_SDT_STR_U8, FALSE);
	xvoArrayAppendText(data, "Sat", 0, XVO_SDT_STR_U8, FALSE);
	xvoArrayAppendText(data, "Sun", 0, XVO_SDT_STR_U8, FALSE);
	xvalue yAxis = xvoCreateTable();
	xvoTableSetValue(option, "yAxis", 5, yAxis, TRUE);
	xvoTableSetText(yAxis, "type", 4, "value", 0, XVO_SDT_STR_U8, FALSE);
	...
	xvoTableSetText(arr0, "type", 4, "line", 0, XVO_SDT_STR_U8, FALSE);
