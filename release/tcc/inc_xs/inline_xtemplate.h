...
// 数据类型 - 主类型
#define XTE_DT_NULL			0
#define XTE_DT_BOOL			1
#define XTE_DT_INT			2
#define XTE_DT_FLOAT		3
#define XTE_DT_TEXT			4
#define XTE_DT_ARRAY		100
#define XTE_DT_TABLE		101
#define XTE_DT_CUSTOM		255
...
XXAPI XTE_Value xteParseJSON_File(char* sFile);
XXAPI XTE_Value xteParseJSON(char* sText, size_t iSize);
XXAPI int xteStringifyJSON_File(char* sFile, XTE_Value varVal, int bFormat);
XXAPI char* xteStringifyJSON(XTE_Value varVal, int bFormat, size_t* pRetSize);
XXAPI void xtePrintValue(XTE_Value objVal, int iLevel, int iMode, int iKey, char* sKey);
